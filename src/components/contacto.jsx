          ...
          <h1 className="text-4xl font-bold text-white text-center mb-4">Contáctanos</h1>
            ...
            <div className="flex items-center mb-6">
              ...
              <div className="flex space-x-2">
                <a href="#" className="bg-white p-2 rounded-md hover:bg-[#0074D9] transition-colors">
            ...
            <form className="space-y-4">
              ...
              <button type="submit" className="w-full bg-[#0074D9] text-white py-2 hover:bg-purple-700 transition duration-300 transform -skew-x-12">
