...
const Contacto = () => {
  return (
    ...
    <section className="relative h-screen ">
      <img src="/imagencontac.png" alt="Fondo" className="absolute inset-0 w-full h-full object-cover" />

      <div className="absolute inset-0 flex flex-col md:flex-row items-center justify-center md:justify-start md:pl-20">
        <div className="bg-[#191a1b] p-8 max-w-md w-full mb-8 md:mb-0">
        <h2 className="text-4xl text-white mb-2 text-center">Contáctanos</h2>
        <p className="text-gray-300 mb-4">
         ...
         <div className=" p-8  w-full mb-18 md:mb-10 md:mr-22">
          <h2 className="text-4xl text-white mb-9 text-center">Nuestras herramientas</h2>
