    ...
    <section className="relative h-screen">
      ...
      <div className="absolute inset-0 bg-black bg-opacity-50">
        <div className="container mx-auto h-full flex items-center">
          <div className="bg-gray-900 bg-opacity-75 p-8 rounded-lg max-w-md">
            ...
            <form>
              <input type="text" placeholder="Nombre" className="w-full p-2 mb-4 bg-gray-800 text-white rounded" />
              <input type="email" placeholder="Correo" className="w-full p-2 mb-4 bg-gray-800 text-white rounded" />
              <textarea placeholder="Mensaje" rows="4" className="w-full p-2 mb-4 bg-gray-800 text-white rounded"></textarea>
